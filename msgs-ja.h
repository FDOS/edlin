/* msgs.h - messages file (Japanese SHIFT-JIS version)

   Author: Gregory Pietsch, translated by Suzu Minashiro

   DESCRIPTION:

   This is the Japanese-language version of the msgs.h file.  The strings
   were collected using the cstrings program by Eric S. Raymond and
   translated.

   This file was translated into ASCII from the original JIS using a
   simple filter that replaced characters above DEL (127) with their
   octal equivalents.
